...
def colocarFichaMaquina(ficha, fichaContrincante, tablero):
    ...
    if ficha =="X":
        mejorOpcion=estrategia2.laOpcion(tablero,tablero3enRaya.casillasVacias,ficha,False)
    else:
        mejorOpcion=estrategia1.laOpcion(tablero,tablero3enRaya.casillasVacias,ficha,False)
    #  ---------------------
    if(mejorOpcion!=-1):
        casilla=mejorOpcion
    else:
